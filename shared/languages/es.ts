export const ES = {
   ...
   AccountLevelSupporterPack: "Posee un paquete de apoyo",
   AccountLevelTribune: "Tribuno",
   AccountLevelUpgradeConditionAnyHTML: "Para actualizar su cuenta, sólo tiene que cumplir <b>uno de los siguientes criterios</b>:",
   AccountSupporter: "Propietario del Pack de Apoyo",
   ...
   AccountUpgradeConfirmDescV2: "Al actualizar su cuenta, <b>se restablecerá su carrera actual</b> y se transferirán grandes personas permanentes dentro de los niveles permitidos. Esto <b>no se puede</b> deshacer, ¿seguro que continuarás?",
   Acropolis: "Acrópolis",
   ...
   AntiCheatFailure: "El rango de su cuenta se ha restringido debido <b>a que no pasó la verificación antitrampas</b>. Póngase en contacto con el desarrollador si desea apelar esto",
   ...
   ApolloProgramDesc: "Todas las fábricas de cohetes obtienen +2 a la producción, a la capacidad de los trabajadores y al multiplicador de almacenamiento. Las fábricas de satélites, las fábricas de naves espaciales y los silos de misiles nucleares obtienen un multiplicador de producción de +1 por cada fábrica de cohetes adyacente",
   ApplyToAll: "Aplicar a todos",
   ApplyToAllBuilding: "Aplicar a todos %{building}",
   ApplyToBuildingInTile: "Aplicar a todos los mosaicos %{building} dentro de %{tile}",
   ApplyToBuildingsToastHTML: "Se aplicó con éxito a <b>%{count} %{building}</b>",
   Aqueduct: "Acueducto",
